...
<html lang="en">
    <head>
        ...
        <title>Shop Homepage - Tienda Ugareño</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="accesorios.php">Accesorios</a></li>
                        <li class="nav-item"><a class="nav-link" href="calzado.php">Calzados</a></li>
                        ...
                        <li><a class="dropdown-item" href="remera.php">Remera</a></li>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Tienda Ugareño</h1>
                    <br>
                    <p class="lead fw-normal text-white-50 mb-0">Aqui encontrarás pantalones Originales y lucí todos los días con actitud, diseño y confort.</p>
                </div>
            </div>
        </header>
        <!-- Section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                  ...
                  $consulta="SELECT * FROM `ropa` WHERE `tipo_prenda` = 'pantalón'";
