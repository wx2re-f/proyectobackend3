...
<html lang="en">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="calzado.php">Recién llegados</a></li>
                        ...
                        <li><a class="dropdown-item" href="remera.php">Remeras</a></li>
                    ...
                    <form class="d-flex">
                        <button class="btn btn-outline-dark" type="submit">
                          ...
                          <a href="login.html">Administradores
                                                  </a>
                        </button>
                    </form>
                </div>
   ...
   <button class="btn btn-outline-dark" type="submit">
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">&copy Copyright Paola Alejandra Romero / 2022</p>
              <br>
